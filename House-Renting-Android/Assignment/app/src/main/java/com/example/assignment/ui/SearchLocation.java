 ...
 public class SearchLocation extends Fragment {
                 ...
                 OnGetGeoCoderResultListener listener = new OnGetGeoCoderResultListener() {
                     ...
                     public void onGetGeoCodeResult(GeoCodeResult result) {
                         if (result == null || result.error != com.baidu.mapapi.search.core.SearchResult.ERRORNO.NO_ERROR) {
                             FragmentUtils.toast(SearchLocation.this, "未找到地址");
                             return;
                         }
     ...
     private void updateMap(LatLng latLng, String location) {
         mBaiduMap.clear();
         mBaiduMap.addOverlay(new MarkerOptions().position(latLng).title(location));
         mBaiduMap.animateMapStatus(MapStatusUpdateFactory.newLatLngZoom(latLng, 12f));
         binding.tvAddressLine.setText(location);
         mBaiduMap.addOverlay(new CircleOptions()
                 .center(latLng).radius(1000)
                 .stroke(new Stroke(3, 0x550000FF))
